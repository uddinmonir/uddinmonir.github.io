...
= 1.12.3 = 
* Fix: Fixed Modal Popup Issue.
* Fix: Issue in Content Switcher, background images not loading when switching the content.
* Fix: Issue in Filterable Gallery, small images open in Lightbox.
